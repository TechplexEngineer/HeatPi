...
export async function openPromisified(busNumber: number, options?: OpenOptions): Promise<PromisifiedBus> {
    return {
        ...
        i2cWrite(address: number, length: number, buffer: Buffer): Promise<BytesWritten> { return {} as any },
